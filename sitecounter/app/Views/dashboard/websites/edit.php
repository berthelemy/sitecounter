...
<head>
    <meta charset="UTF-8">
    <title>Edit Website - SiteCounter</title>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="/dashboard/websites/<?= $website['id'] ?>/update">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">A descriptive name for your website.</div>
                            </div>

                            <div class="mb-3">
                                <label for="url" class="form-label">Website URL</label>
                                <input type="url" class="form-control" id="url" name="url" value="<?= old('url', $website['url']) ?>" required>
                                <div class="form-text">The full URL of your website (e.g., https://example.com).</div>
                            </div>

                            <div class="d-flex justify-content-between">
                                <a href="/dashboard/websites" class="btn btn-secondary">Cancel</a>
