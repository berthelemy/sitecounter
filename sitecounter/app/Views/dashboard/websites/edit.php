...
<head>
    <meta charset="UTF-8">
    <title><?= lang('SiteCounter.websites.edit_title') ?> - <?= lang('SiteCounter.app.name') ?></title>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h4><?= lang('SiteCounter.websites.edit_title') ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post" action="/dashboard/websites/<?= $website['id'] ?>/update" novalidate>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="/dashboard/websites" class="btn btn-secondary"><i class="bi bi-arrow-left me-1"></i><?= lang('SiteCounter.app.cancel') ?></a>
                                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i><?= lang('SiteCounter.websites.update_button') ?></button>
                            </div>
                        </form>
                    </div>
                </div>
