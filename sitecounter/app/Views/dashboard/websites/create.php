            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="/dashboard/websites/store" novalidate>
                            <?= csrf_field() ?>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i><?= lang('SiteCounter.websites.create_button') ?></button>
                            </div>
                        </form>
                    </div>
                </div>
